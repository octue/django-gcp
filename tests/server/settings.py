...
# STORAGES — one alias per store (Django 5.1+ replaces DEFAULT_FILE_STORAGE,
# STATICFILES_STORAGE, GCP_STORAGE_MEDIA, GCP_STORAGE_STATIC, GCP_STORAGE_EXTRA_STORES).
STORAGES = {
    "default": {
...
# MEDIA_URL / STATIC_URL are still used by Django for URL generation by
# FileField.url() and {% static %} template tag respectively, even with STORAGES.
