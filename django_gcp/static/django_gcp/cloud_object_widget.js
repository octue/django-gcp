...
function clearSelected(wrapper) {
  ...
  wrapper.find(".gcp-clear-selected").addClass("gcp-disabled gcp-hidden").prop("disabled", true);
}
...
function addSelected(wrapper, name, contentType) {
  ...
  wrapper.find(".gcp-clear-selected").removeClass("gcp-disabled gcp-hidden").prop("disabled", false);
}
